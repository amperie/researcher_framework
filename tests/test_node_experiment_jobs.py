...
PROFILE = {"name": "test", "experiment_adapter": "core.plugins.test_adapter"}
...
def test_submit_experiment_jobs_delegates_to_adapter():
    ...
    with patch("core.graph.nodes.submit_experiment_jobs.load_adapter", return_value=adapter):
...
def test_check_experiment_jobs_delegates_to_adapter():
    ...
    with patch("core.graph.nodes.check_experiment_jobs.load_adapter", return_value=adapter):
